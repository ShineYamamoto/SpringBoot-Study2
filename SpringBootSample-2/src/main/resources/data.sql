...
INSERT INTO m_user (
 ...
 ,('user5@example.co.jp', 'password', 'ユーザー5', '2000-01-01', 26, 2, 2, 'ROLE_GENERAL')
 ,('user6@example.co.jp', 'password', 'ユーザー6', '2000-01-01', 26, 2, 2, 'ROLE_GENERAL')
 ,('user7@example.co.jp', 'password', 'ユーザー7', '2000-01-01', 26, 2, 2, 'ROLE_GENERAL')
 ,('user8@example.co.jp', 'password', 'ユーザー8', '2000-01-01', 26, 2, 2, 'ROLE_GENERAL')
 ,('user9@example.co.jp', 'password', 'ユーザー9', '2000-01-01', 26, 2, 2, 'ROLE_GENERAL')
 ,('user10@example.co.jp', 'password', 'ユーザー10', '2000-01-01', 26, 2, 2, 'ROLE_GENERAL')
;
